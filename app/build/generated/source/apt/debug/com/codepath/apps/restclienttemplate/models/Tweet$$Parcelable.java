    ...
    implements Parcelable, ParcelWrapper<com.codepath.apps.restclienttemplate.models.Tweet>
{
    ...
    public static void write(com.codepath.apps.restclienttemplate.models.Tweet tweet$$1, android.os.Parcel parcel$$1, int flags$$0, IdentityCollection identityMap$$0) {
        ...
        if (identity$$0 != -1) {
            ...
            parcel$$1 .writeInt((tweet$$1 .hasFavorited? 1 : 0));
            parcel$$1 .writeInt((tweet$$1 .hasRetweeted? 1 : 0));
            parcel$$1 .writeInt((tweet$$1 .hasMedia? 1 : 0));
            com.codepath.apps.restclienttemplate.models.Media$$Parcelable.write(tweet$$1 .media, parcel$$1, flags$$0, identityMap$$0);
    ...
    public static com.codepath.apps.restclienttemplate.models.Tweet read(android.os.Parcel parcel$$3, IdentityCollection identityMap$$1) {
        ...
        if (identityMap$$1 .containsKey(identity$$1)) {
            ...
            tweet$$4 .hasFavorited = (parcel$$3 .readInt() == 1);
            tweet$$4 .hasRetweeted = (parcel$$3 .readInt() == 1);
            tweet$$4 .hasMedia = (parcel$$3 .readInt() == 1);
            Media media$$0 = com.codepath.apps.restclienttemplate.models.Media$$Parcelable.read(parcel$$3, identityMap$$1);
            tweet$$4 .media = media$$0;
            ...
            tweet$$4 .favoriteCount = parcel$$3 .readInt();
